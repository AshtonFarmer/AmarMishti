/* Emergency restored Tanima Eyes Only */
(function(){
  ...
  document.querySelectorAll(".keypad button").forEach(btn=>{
    btn.addEventListener("click",()=>{
      ...
      if(btn.dataset.clear){ entered=""; updateDots(); }
    });
  });
  ...
  function openLetter(){
    ...
    setTimeout(()=>page.classList.add("paper-out"),650);
    setTimeout(()=>page.classList.add("paper-unfold"),1650);
    setTimeout(()=>page.classList.add("paper-glow"),2650);
    setTimeout(()=>page.classList.add("video-revealed"),3900);
    setTimeout(()=>{
